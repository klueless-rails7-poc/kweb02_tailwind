KManager.action :bootstrap do
  action do
    application_name = :kweb02_tailwind
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'Sample Rails 7 application using tailswind css and hotwire turboframes',
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 '',
        copyright_date:             '2022',
        website:                    'http://appydave.com/gems/kweb02-tailwind'
      )
      .github(
        active: false,
...
KManager.opts.app_name                    = 'kweb02-tailwind'
